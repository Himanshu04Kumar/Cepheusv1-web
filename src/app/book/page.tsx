          ...
          {step === 2 && (
            <div className="space-y-6 text-left">
              ...
              <div className="space-y-2">
                ...
                <input name="customer_phone" placeholder="99xxxxxxxx" className="w-full p-5 bg-[#f8f8f7] dark:bg-slate-950 border border-black/5 dark:border-white/5 rounded-2xl text-[#09090b] dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-500 outline-none focus:ring-2 focus:ring-indigo-500/20 font-bold transition-all" value={formData.customer_phone} onChange={handleChange} />
              </div>
              <div className="space-y-2">
                <label className="text-[10px] font-black uppercase tracking-widest text-slate-400 ml-4">Full Address</label>
                <textarea name="pickup_address" placeholder="Delhi Coordinate Details" className="w-full p-5 bg-[#f8f8f7] dark:bg-slate-950 border border-black/5 dark:border-white/5 rounded-2xl text-[#09090b] dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-500 outline-none focus:ring-2 focus:ring-indigo-500/20 font-bold transition-all h-32" value={formData.pickup_address} onChange={handleChange} />
              </div>
            </div>
          )}
